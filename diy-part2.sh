...
#sed -i 's/"Frp 内网穿透"/"超级服务器外网穿透"/g' package/lean/luci/blob/master/applications/luci-app-frps/po/zh-cn/frps.po

#sed -i 's/"Turbo ACC 网络加速"/"网络加速"/g' package/lean/luci/blob/master/applications/luci-app-turboacc/po/zh-cn/turboacc.po
