...
#### 稳定版修改R21xxx+自己的名字
sed -i 's/R21.8.6/LSP 2021.08.16/g' package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/"CPU 性能优化调节设置"/"处理器优化调节设置"/g' package/lean/luci-app-cpufreq/po/zh-cn/cpufreq.po 
