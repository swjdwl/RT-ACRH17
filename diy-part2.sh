...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='DiaodoraBox'' package/lean/default-settings/files/zzz-default-settings

#### 版本号里显示一个自己的名字（ababwnq build $(TZ=UTC-8 date "+%Y.%m.%d") @ 这些都是后增加的）
sed -i "s/OpenWrt /DiaodoraBox /g" package/lean/default-settings/files/zzz-default-settings

#### 稳定版修改R21xxx+自己的名字
#sed -i 's/R21.10.1/Game Over/g' package/lean/default-settings/files/zzz-default-settings
